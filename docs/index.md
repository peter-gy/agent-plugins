...
layout: home
title: agent-plugins
description: Ship Agent Plugins with Python packages as one synchronized release.
...
# SVG paths use Tabler Icons through Iconify under the MIT license.
features:
  - title: Package once for compatible clients
    icon: >-
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m12 21l-8-4.5v-9L12 3l8 4.5V12m-8 0l8-4.5M12 12v9m0-9L4 7.5M15 18h7m-3-3l3 3l-3 3"/></svg>
    details: Use one manifest and fixed locations for skills and MCP servers, with namespaced extensions for client-specific behavior.
    link: /guide/plugin-directory
    linkText: Organize the plugin
  - title: Version plugin and library together
    icon: >-
  ...
  - title: Install once, discover directly
    ...
    details: Locate the installed plugin by distribution name and inspect its manifest, components, and extension files.
    link: /guide/inspect-installed
